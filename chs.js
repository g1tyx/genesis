...
var cnItems = {
    ...
    'Instability': '不稳定性',
    'Make fluctuations scale half as fast.': '波动价格增长速度减半。',
    ...
    '': '',
    '': '',
    'You have reached the end of the game!': '你已经到达游戏的终点了!',
    'Destroy everything and start over.': '摧毁一切，重新开始。',
    'Start each reset with 10 reflectors.': '每次重置开局时默认有 10 个反射器。',
    'Autobuy fluctuations, and they don\'t consume photons.': '自动购买波动，而且它们不消耗光子。',
    'Reach 5.00e14 photons without fluctuations.': '没有波动的情况下达到 5.00e14 光子。',
    'Reach 1e25 photons without buying oxygen atoms.': '不需要购买氧原子就能达到1e25光子。',
    'Reach 1e18 photons.': '达到 1e18 光子.',
    ...
    'Super-energy now makes time pass by 4x faster for all mechanics below reflection and super-energy.': '现在，超能化使反射和超能以下所有力学的时间缩短了4倍。',
    'Every energization has a reduced chance of producing an atom.': '每次通电都会有几率产生原子。',
...
var cnPostfix = {
    ...
    "You have": "你有 ",
    "Effects": "效果",
    "Autobuy perceptive warps.": "自动购买感知曲速。",
    "Automatically super-energize.": "自动超能化。",
    "Reflectors scale twice as slow but you don\'t keep them on resets.": "反射镜的速度变慢两倍，但你不能在重置时保持它们。",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^(.+)You have (.+) atom$/, '你有 $2 原子'],
    [/^(.+)Cost: (.+) photons\n(.+)$/, '成本: $2 光子'],
    [/^(.+)Cost: (.+) stars\n(.+)$/, '成本: $2 恒星'],
    [/^(.+)Draw Photons: No\n(.+)$/, '绘制光子:否'],
    [/^(.+)Draw Anything At All: No\n(.+)$/, '绘制任何东西:否'],
    [/^(.+)Draw Anything At All: Yes\n(.+)$/, '绘制任何东西:是'],
    [/^and boosting the fluctuation cap by (.+).\n(.+)$/, '并将波动上限提高 $1。'],
    [/^Use (.+) silicon and (.+) copper to create (.+) dyson module.$/, '使用 $1 Si 和 $2 Cu 来创建 $3 戴森模块。'],
    [/^(.+)Primary atoms\n(.+)$/, '初级原子'],
    [/^(.+)Secondary atoms\n(.+)$/, '次级原子'],
    [/^(.+)Draw Photons: Yes\n(.+)$/, '绘制光子:是'],
    [/^(.+)You have (.+) photons.\n(.+)$/, '你有 $2 光子.'],
    [/^(.+)You have (.+) fluctuations$/, '你有 $2 波动'],
    [/^(.+)You have (.+) fluctuation$/, '你有 $2 波动'],
    ...
    [/^(.+)You have (.+) solar energy.$/, '你有 $2 太阳能。'],
    [/^(.+)You have (.+) dyson modules, producing (.+) solar energy\/s.$/, '你有 $2 戴森模块，产生 $3 太阳能\/秒。'],
    [/^(.+)They are boosting photon and star gain by (.+),$/, '它们将光子和恒星增益提高了 $2，'],
    ...
    [/^Requires: (.+) atoms$/, '需要：$1 原子'],
    [/^Requires: (.+) fluctuations$/, '需要：$1 波动'],
    [/^Requires: (.+) atoms and (.+) fluctuations$/, '需要：$1 原子和 $2 波动'],
    ...
    [/^Multiply photon amount by (.+) over the course of 30 seconds$/, '在30秒内将光子数量乘以 $1'],
    [/^While reaction active, make fluctuations x(.+) faster$/, '反应激活时，使波动速度变快 x$1'],
